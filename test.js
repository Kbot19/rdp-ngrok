...
(async () => {
  ...
  await page.type('input[name=reg_email__]', 'puddygroskya.te.p548.0@gmail.com');
  await page.type('input[name=reg_email_confirmation__]', 'puddygroskya.te.p548.0@gmail.com');
